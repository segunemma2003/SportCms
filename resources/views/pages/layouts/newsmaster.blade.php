...
<div class="wrap push">
	...
	<header class="header style-3">
		...
		<div class="page-topbar-and-logobar">
			<div class="container">
				...
				<ul class="user-login-option pull-right">
					...
					<li class="login-modal">
						<a href="#" class="login" data-toggle="modal" data-target="#login-modal"><i class="fa fa-user"></i>Fan Login</a>
						  	...
						  	<div class="login-form position-center-center">
								...
								<form>
									<div class="form-group">
										<input type="text" class="form-control" name="user" placeholder="youremail@gmail.com">
					...
					<li class="language-dropdown">
				    	<a id="choses-lang" href="#"><i class="fa fa-envelope-o"></i>Feedback</a>
		...
		<div class="container">
				...
				<li><a href="{{route('news')}}">Club News</a></li>
				<li>News Detail</li>
			</ul>
		</div>
	</div>
	<div class="bring-forward" data-appear-top-offset="0" data-parallax="scroll" data-image-src="../main/images/parallax-bg/news.jpg">
