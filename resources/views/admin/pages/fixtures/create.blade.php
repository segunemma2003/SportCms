            ...
            <div class="panel panel-default">
                ...
                @endif
                    <form method="POST">
                        ...
                        <!-- matchday -->
                        <div class="form-group row">
                            <label for="matchday" class="col-sm-4 col-form-label text-md-right">{{ __('Match day') }}</label>

                            <div class="col-md-6">
                            <input id="matchday" type="text" class="form-control{{ $errors->has('matchday') ? ' is-invalid' : '' }}" name="matchday" required>
                                

                                @if ($errors->has('matchday'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('matchday') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
