                ...
                <div class="panel-body">
                    <form method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="competition_name" type="text" class="form-control{{ $errors->has('competition_name') ? ' is-invalid' : '' }}" name="competition_name" value="{{ old('competition_name') }}" required autofocus>
